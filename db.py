...
SQL_DELETE_SET_FILE_MAP = 'DELETE FROM set_file_map WHERE set_id = ? AND file_id = ?'
SQL_DELETE_SET_SYMLINK_MAP = 'DELETE FROM set_symlink_map WHERE set_id = ? AND symlink_id = ?'
SQL_DELETE_SET_DIR_MAP = 'DELETE FROM set_dir_map WHERE set_id = ? AND dir_id = ?'
